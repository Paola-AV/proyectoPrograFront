...
//componente con el footer de la pagina
function Footer() {
    //variable que permite "navegar" por la pagina al pasarle una ruta
        ...
        <section className="footerSec">
            ...
            <div className="footerComp">
                <ul className="footerUl">
                    <li><a className="footerA" onClick={() => navigate('/casas')}>Propiedades</a></li>

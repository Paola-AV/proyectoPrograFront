...
//componente de la pagina de inicio desde la vista de trabajador
export function HomeT() {
    ...
    return (
        <section className="homeTSec">
            <div>
                <img className="imgHomeT" src="cover2.jpg"></img>
            ...
            <div className="homeOptions">
                ...
                <div className="HomeBox" onClick={() => navigate('/Usuario')}>
                    ...
                    <p className="homeP">Revisa tu informacion<br />Cambio de contraseña<br /></p>
                </div>
